// supabase/functions/process-pending-deletions/maintenance-auth.ts
//
// Same logic as process-pending-asset-deletions' maintenance-auth.ts
// (kept as a duplicated file rather than a true cross-function shared
// module, due to Edge Function bundling constraints -- both copies
